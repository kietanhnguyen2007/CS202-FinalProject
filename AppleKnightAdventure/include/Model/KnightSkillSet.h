...
// Manages all three knight attack slots independently.
...
public:
    ...
    // Attack 3 — Lunge Thrust (U): rushes forward, medium damage, 1.25s cooldown
    SkillData attack3 { 32, 1.25f, 0.0f, 0.45f };

    // Lunge state for Attack3
    bool  m_isLunging  = false;
    float m_lungeTimer = 0.0f;
    float m_lungeSpeed = 1000.0f;
